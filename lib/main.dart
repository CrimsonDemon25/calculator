                ...
                Container(
                    ...
                    child: Table(
                      children: [
                        ...
                        TableRow(children: [
                          buildButton(
                              "7", 0.2, Colors.black45, Colors.amberAccent),
                          buildButton(
                              "8", 0.2, Colors.black45, Colors.amberAccent),
                          buildButton(
                              "9", 0.2, Colors.black45, Colors.amberAccent),
                          buildButton("x", 0.2, Colors.white, Colors.black)
                        ]),
                        TableRow(children: [
                          buildButton(
                              "4", 0.2, Colors.black45, Colors.amberAccent),
                          buildButton(
                              "5", 0.2, Colors.black45, Colors.amberAccent),
                          buildButton(
                              "6", 0.2, Colors.black45, Colors.amberAccent),
                          buildButton("-", 0.2, Colors.white, Colors.black)
                        ]),
                        TableRow(children: [
                          buildButton(
                              "1", 0.2, Colors.black45, Colors.amberAccent),
                          buildButton(
                              "2", 0.2, Colors.black45, Colors.amberAccent),
                          buildButton(
                              "3", 0.2, Colors.black45, Colors.amberAccent),
                          buildButton("+", 0.2, Colors.white, Colors.black)
                        ]),
                        TableRow(
                          children: [
                            buildButton("%", 0.2, Colors.white, Colors.black),
                            buildButton(
                                "0", 0.2, Colors.black45, Colors.amberAccent),
                            buildButton(".", 0.2, Colors.white, Colors.black),
                            buildButton("=", 0.2, Colors.white, Colors.black),
                          ],
                        )
